...
<div class="mianbao">
  ...
  <el-row class="row-box">
    ...
    <el-col :span="13" :offset="3">
      <editors @article-changes="articleChanges"></editors>
    </el-col>
  </el-row>
  <el-row class="row-box">
      <el-col :span="3">
    ...
    <div v-for="item in activity.place_AllUrbanData">
      <el-input v-model="item.place_address" size="small" placeholder="地点" style="display: inline-block;width:25%;"></el-input>
  ...
  <el-row class="row-box">
    ...
    <el-col :span="3" style="border-bottom:1px solid #dcdfe6;">
      <el-checkbox v-model="activity.Requiredpersonnel_surname" @change="personnelSurnameChange">协同人员信息</el-checkbox>
    </el-col>
    <el-col :span="2" style="border-bottom:1px solid #dcdfe6;">
  ...
  <el-row class="row-box">
    ...
    <el-col :span="3">
      <el-checkbox v-model="activity.Selectionpersonnel_surname" @change="ispersonnelSurnameChange">协同人员信息</el-checkbox>
    </el-col>
    <el-col :span="2">
  ...
  <el-row class="row-box">
      ...
      <el-col :span="14" :offset="3">
        <EditorEnd @article-changes="articleChangeEnd"></EditorEnd>
      </el-col>
  </el-row>
  <el-row class="row-box">
      <el-col :span="3">
...
export default {
  ...
  methods: {
    ...
    add() {
      let _this = this;
      console.log(_this.activity.optional)
        ...
        for (var n = 0; n < _this.activity.place_AllUrbanData.length; n++) {
          _this.activity.place_AllUrbanData[n].place_start_time = new Date(_this.activity.place_AllUrbanData[n].place_start_time).getTime()
          _this.activity.place_AllUrbanData[n].place_end_time = new Date(_this.activity.place_AllUrbanData[n].place_end_time).getTime()
        }
      let result = post("/manager/activity/create", {
        ...
        end_time: (
          ...
          end_registration_time: (
              new Date(_this.activity.end_registration_time).getTime() +
              3600 * 1000 * 24
          ).toString(),
